    ...
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(
                FadeSlideRoute(page: PromptsManagementScreen(accountId: widget.accountId)),
              );
            },
      ...
      body: TabBarView(
        ...
        children: [
          ...
          Container(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  Navigator.of(context).push(
                    FadeSlideRoute(page: GenerateReportScreen(accountId: widget.accountId)),
                  );
                },
          ...
          Expanded(
            child: _isLoading
                ? const ShimmerLoadingList(itemCount: 5, itemHeight: 120) // UX-audit #4: shimmer instead of spinner
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            return ReportCard(
                              ...
                              onTap: () {
                                Navigator.of(context).push(
                                  FadeSlideRoute(page: ReportDetailScreen(
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: const CircleAvatar(
                              ...
                              child: Icon(Icons.description, color: AppTheme.primaryIndigo),
                            ),
                            title: Text(
                              userName,
